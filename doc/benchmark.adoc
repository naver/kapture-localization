...
NOTE: If you followed the dataset download instructions provided above, you will already have downloaded the maps we used for our benchmark. For Aachen, e.g., the downloaded map can be found at ```Aachen-Day-Night-v1.1/colmap-sfm/r2d2_WASF-N8_20k/frustum_thresh10_far50/colmap```. If this is the case you can skip this part.
...
NOTE: We will use the downloaded maps here. If you created your own maps, please point the argument ```--colmap-map``` to their location (e.g. ```--colmap-map Aachen-Day-Night-v1.1/colmap-sfm/r2d2_WASF-N8_20k/ir_benchmark/colmap```).
...
kapture_pipeline_image_retrieval_benchmark.py -v info \
      ...
      -matches RobotCar_Seasons-v1/local_features/r2d2_WASF-N8_20k/NN_no_gv/matches \
      -matches-gv RobotCar_Seasons-v1/local_features/r2d2_WASF-N8_20k/NN_colmap_gv/matches \
      --colmap-map RobotCar_Seasons-v1/colmap-sfm/r2d2_WASF-N8_20k/frustum_thresh10_far50/colmap \
