...
wget Aachen_Day_Night_1_1_ir_benchmark_pairs.txt Aachen-Day-Night-v1.1/pairsfile/mapping/ # TODO
...
wget baidu_mall_ir_benchmark_pairs.txt baidu-mall/pairsfile/mapping/ # TODO
kapture_pipeline_mapping.py -v info \
...
wget RobotCar_Seasons_v1_ir_benchmark_pairs.txt RobotCar_Seasons-v1/pairsfile/mapping/ # TODO
kapture_pipeline_mapping.py -v info \
