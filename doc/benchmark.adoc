...
mv Aachen-Day-Night-v1.1/map_plus_query/reconstruction/keypoints/r2d2_WASF_N8_big Aachen-Day-Night-v1.1/local_features/r2d2_WASF-N8_20k/keypoints
mv Aachen-Day-Night-v1.1/map_plus_query/reconstruction/descriptors/r2d2_WASF_N8_big Aachen-Day-Night-v1.1/local_features/r2d2_WASF-N8_20k/descriptors

mkdir -p baidu-mall/local_features/r2d2_WASF-N8_20k
mv baidu-mall/map_plus_query/reconstruction/keypoints/r2d2_WASF_N8_big baidu-mall/local_features/r2d2_WASF-N8_20k/keypoints
mv baidu-mall/map_plus_query/reconstruction/descriptors/r2d2_WASF_N8_big baidu-mall/local_features/r2d2_WASF-N8_20k/descriptors

mkdir -p RobotCar_Seasons-v1/local_features/r2d2_WASF-N8_20k
mv RobotCar_Seasons-v1/map_plus_query/reconstruction/keypoints/r2d2_WASF_N8_big RobotCar_Seasons-v1/local_features/r2d2_WASF-N8_20k/keypoints
mv RobotCar_Seasons-v1/map_plus_query/reconstruction/descriptors/r2d2_WASF_N8_big RobotCar_Seasons-v1/local_features/r2d2_WASF-N8_20k/descriptors
```
...
NOTE: If you followed the dataset download instructions provided above, you will have downloaded the maps we used for our benchmark in the papers. However, in order to run your own benchmark, you have to compute your own maps (our map cannot be used because there is no guarantee that your local features correspond to our keypoints in the map).
