...
kapture_pipeline_mapping.py -v info \
    ...
    --colmap-map ./tutorial/colmap-sfm/r2d2_500/AP-GeM-LM18_top5  `# lfeat type / map pairs` \
    --topk 5
----
...
colmap gui \
    ...
    --import_path ./tutorial/colmap-sfm/r2d2_500/AP-GeM-LM18_top5/reconstruction/ # only available in colmap 3.6
----
...
colmap gui \
    ...
    --import_path ./tutorial/colmap-localization/r2d2_500/AP-GeM-LM18_top5/AP-GeM-LM18_top5/colmap_localized/reconstruction/ # only available in colmap 3.6
----
