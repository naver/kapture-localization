...
.Localization of query images in an SFM map.
[[fig_localization]]
...
For example, if you want to evaluate your global features only on global SFM, you could pass
`--skip local_sfm pose_approximation` to the script.
